...
public class NavigationService : IDisposable
{
    ...
    public void FlyToPosition(Vector3 position, bool force = false)
    {
        ...
        RememberActivePositionNavigation(PositionNavigationKind.FlyTo, position);
    ...
    public void MoveToPosition(Vector3 position)
    {
        ...
        TargetPosition = position;
        RememberActivePositionNavigation(PositionNavigationKind.MoveTo, position);
    ...
    {
        return State == NavigationState.Flying
