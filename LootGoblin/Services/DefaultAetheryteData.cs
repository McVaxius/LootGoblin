...
public static class DefaultAetheryteData
{
    public static Dictionary<uint, AetherytePosition> GetDefaults()
    {
        return new Dictionary<uint, AetherytePosition>
        {
            ...
            // NOTE: House of the Fierce coords were wrong (copied from Namai). 
            // Removed from defaults so it appears in "Find Missing Aetherytes" tool for manual recording.
            // User will provide correct XYZ via the tool.
