...
public static class TreasureMapData
{
    public static readonly Dictionary<uint, TreasureMapInfo> KnownMaps = new()
    {
        ...
        { 39592, new TreasureMapInfo { ItemId = 39592, Name = "Timeworn Br'aaxskin Map", Tier = MapTier.Party, MinLevel = 100, Expansion = "DT", HasDungeon = true, Category = MapCategory.Roulette, Status = ImplementationStatus.Implemented, DungeonTerritoryId = 1209, InstanceName = "Cenote Ja Ja Gural" } },
